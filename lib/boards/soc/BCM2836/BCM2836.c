...
void BCM2836_init(const mmio_t *mmio) {
    SYS_TMR_2836 = (volatile bcm2835_sys_timer_regs_t *)(mmio->base + 0x3000);
    ...
    MAILBOX_VC_2836 = (volatile bcm2835_mailbox_vc_regs_t *)(mmio->base + 0xB880);
    GPIO_CLKS_2836 = (volatile bcm2835_gp_clks_regs_t*)(mmio->base + 0x101070);
    GPIO_2836 = (volatile bcm2835_gpio_regs_t *)(mmio->base + 0x200000);
    ...
    AUX_2836 = (volatile bcm2835_aux_regs_t *)(mmio->base + 0x215000);
    MU_2836 = (volatile bcm2835_mu_regs_t *)(mmio->base + 0x215000 + 0x40);
