...
void BCM2835_Init(uintptr_t mmio_base) {
    ...
    SPI = (volatile spi_regs_t *)(mmio_base + 0x204000);
    ...
    MU = (volatile mu_regs_t *)(mmio_base + 0x215000);
    SPI1 = (volatile spi1_regs_t *)(mmio_base + 0x215000 + 0x80);
    SPI2 = (volatile spi2_regs_t *)(mmio_base + 0x215000 + 0xC0);
